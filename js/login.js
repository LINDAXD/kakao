$(document).ready(function(){
        ...
        //회원(주문조회) 로그인 버튼
        $("#btn_wrap1").mouseover(function(){$("#s_btn1").stop().animate({opacity:"0"},"fast");
        }).mouseout(function(){
            $("#s_btn1").stop().animate({opacity:"1"},"fast");
        });
    
        //비회원(주문조회) 로그인 버튼
        $("#btn_wrap2").mouseover(function(){$("#s_btn3").stop().animate({opacity:"0"},"fast");
        }).mouseout(function(){
